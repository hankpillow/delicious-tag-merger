...
class MainHandler(webapp.RequestHandler):
	...
	def post(self):
		...
		response = {}
		try:
			result = urlfetch.fetch(url=("https://api.del.icio.us/v1/tags/rename?old="+old_tag+"&new="+new_tag),headers={"Authorization": "Basic %s" % base64.b64encode(username+":"+password)},deadline=60, allow_truncated=True)
